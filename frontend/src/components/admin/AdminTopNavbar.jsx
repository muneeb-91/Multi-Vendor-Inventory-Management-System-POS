...
import { ADMIN_NO_SEARCHBAR_ROUTES } from "../../data";

const TopNavbar = ({ onMenuToggle, placeholder = "Search..." }) => {
  const { pathname } = useLocation();
  const showSearchBar = !ADMIN_NO_SEARCHBAR_ROUTES.includes(pathname);
